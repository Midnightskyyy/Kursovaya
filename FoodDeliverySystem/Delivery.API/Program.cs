...
{
    public static async Task Initialize(DeliveryDbContext context)
    {
        if (!context.Couriers.Any())
        {
            var couriers = new List<Courier>
            {
                ...
                {
                    Id = Guid.NewGuid(),
                    UserId = Guid.NewGuid(), // В реальной системе это будет ID из Auth сервиса
                    Name = "Иван Петров",
